    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Sale-Return List</i></span></strong></h4>
                <a href="#" data-bs-toggle="modal"
                    data-bs-target="#largeModal" class="btn btn-primary"><i class="bx bx-add-to-queue"></i> Add New Sale-Return</a>
            </div>
            <div class="card-body">
