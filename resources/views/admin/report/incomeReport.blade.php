    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Income-Report</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                    ...
                    <table class="table" id="saleReport">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><strong>{{ \Carbon\Carbon::parse($income['sale_date'])->format('d-M-Y') }}</strong></td>
                                <td class="text-center"><strong>Sales</strong></td>
                                <td class="text-center"><strong>{{ $income['currency_rate'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['vat'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['total'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['cash'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['card'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['walkin'] }}</strong></td>
                                <td class="text-center"><strong>{{ $income['member_ship'] }}</strong></td>
