    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Purchase-Report</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="saleReport">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><strong>{{ $purchase['id'] }}</strong></td>
                                <td class="text-center"><strong>{{ \Carbon\Carbon::parse($purchase['purchase_date'])->format('d-M-Y') }}</strong></td>
                                <td class="text-center"><strong>{{ $purchase['company_name'] }}</strong></td>
                                <td class="text-center"><strong>{{ $purchase['currency_rate'] }}$</strong></td>
                                <td class="text-center"><strong>{{ $purchase['subtotal'] }}$</strong></td>
                                <td class="text-center"><strong>{{ $purchase['total'] }}</strong></td>
                                <td class="text-center"><strong>{{ $purchase['remark'] }}</strong></td>
