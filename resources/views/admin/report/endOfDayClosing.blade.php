    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>End of day Closing</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                    ...
                    <table class="table" id="saleReport">
                        ...
                        <thead class="p-3 text-center">
                            <tr>
                                ...
                                <th><strong>T. Sale </strong></th>
                                <th><strong>T. Member dis.</strong></th>
                                <th><strong>T. Exchange</strong></th>
                                <th><strong>T. Difference</strong></th>
                                <th><strong>T. Vat</strong></th>
                                <th><strong>T. Cash</strong></th>
                                <th><strong>T. Card</strong></th>
                        ...
                        <tbody>
                            ...
                            @endphp
                            {{-- @foreach($cus as $rw) --}}
                            @foreach($edcls as $edcl)
                            <tr>
                                <td class="text-center"><strong>{{ $edcl['id'] }}</strong></td>
                                <td class="text-center"><strong>{{ \Carbon\Carbon::parse($edcl['closing_date'])->format('d-M-Y') }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_sale'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_member_dis'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_exchange'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_difference'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_vat'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_cash'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['total_card'] }}</strong></td>
                                <td class="text-center"><strong>{{ $edcl['remark'] }}</strong></td>
