    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Expense-Report</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                    ...
                    <table class="table" id="saleReport">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><strong>21-Mar-2023</strong></td>
                                <td class="text-center"><strong>Purchase</strong></td>
                                <td class="text-center"><strong>$1.00 = 4100.00៛</strong></td>
                                <td class="text-center"><strong>$550</strong></td>
