    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Vat-Report</i></span></strong></h4>
                <div>
                    <!-- PDF Button -->
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="saleReport">
                        ...
                        <tbody>
                            ...
                            @foreach($vats as $vat)
                            <tr>
                                <td class="text-center"><strong>{{ $vat['id'] }}</strong></td>
                                <td class="text-center"><strong>{{ \Carbon\Carbon::parse($vat['sale_date'])->format('d-M-Y') }}</strong></td>
                                <td class="text-center"><strong>Customer</strong></td>
                                <td class="text-center"><strong>{{ $vat['currency_rate'] }}</strong></td>
                                <td class="text-center"><strong>{{ $vat['total_vat'] }}</strong></td>
                                <td class="text-center"><strong>{{ $vat['card'] }}</strong></td>
                                <td class="text-center"><strong>{{ $vat['cash'] }}</strong></td>
