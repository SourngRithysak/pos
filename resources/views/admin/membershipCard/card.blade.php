    ...
    <div class="d-flex align-items-end row">
        <div>
            <div class="d-flex justify-content-between align-items-center card-header">
                <h4 style="margin-bottom: 0px;"><strong><span><i>Card List</i></span></strong></h4>
                <a href="{{ url('/admin/createCard') }}" class="btn btn-primary"><i class="bx bx-add-to-queue"></i> Add New Card</a>
            </div>
            <div class="card-body">
