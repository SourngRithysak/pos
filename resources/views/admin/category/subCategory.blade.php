                                ...
                                <td class="p-3 text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <button class="dropdown-item editCategoryBtn" data-id="{{ $subcategory->id }}"><i class="bx bx-edit-alt me-1"></i>Edit</button>
...
<script>
    $(document).ready(function() {
        ...
        $("#categoryForm").on("submit", function(e) {
            ...
            $.ajax({
                url: "{{ route('subcategories.add') }}", // Update with your route
                type: "POST",
                data: $(this).serialize(),
        ...
        $(".editCategoryBtn").click(function() {
            ...
            $.ajax({
                url: "/admin/subcategories/" + categoryId + "/edit",
                type: "GET",
                success: function(response) {
