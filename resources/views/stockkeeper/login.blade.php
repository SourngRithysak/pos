...
<head>
    ...
    <title>POS - Login as Stock keeper</title>
    <!-- Favicon -->
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none;">Login as Stock keeper</span>
                            </a>
                        </div>
                        <form class="mb-3" action="{{ route('stockkeeper.authenticate') }}" method="POST">
                            @csrf
