...
<head>
    ...
    <title>POS - Login as Cashier</title>
    <!-- Favicon -->
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                <span class="app-brand-text demo text-body fw-bolder" style="text-transform: none;">Login as Cashier</span>
                            </a>
                        </div>
                        <form class="mb-3" action="{{ route('cashier.authenticate') }}" method="POST">
                            @csrf
